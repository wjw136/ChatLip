...
parser.add_argument('-output_dir', type=str, 
                    help='Output video file dir', required=False, default=False)
...
if args.output_dir:
    temp_output = os.path.join(args.output_dir, "output.mp4")
    temp_folder = os.path.join(args.output_dir, "temp")
    # remove last outputs
...
while True:
    ...
    output_video = os.path.join(args.output_dir, output_filename + output_suffix + ".mp4")
